...
class ADPService(object):
    ...
    def __init__(self):
        ...
        self.adp_agent_factory_host = settings.ADP_AGENT_FACTORY_HOST if hasattr(settings, 'ADP_AGENT_FACTORY_HOST') else "http://agent-factory:13020"
    ...
    def stream_debug(self, query, token):
        ...
        params = {"agent_id": self.agent_key,
                  "agent_version": "v0",
                  "input": {"query": query},
                  "conversation_id": "", "stream": True, "inc_stream": True,
                  "executor_version": "v2"}
