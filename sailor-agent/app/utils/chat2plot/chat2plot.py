...
from app.utils.chat2plot.dataset_description import description
from app.utils.chat2plot.dictionary_helper import delete_null_field
from app.utils.chat2plot.prompt import (
    JSON_TAG,
    error_correction_prompt,
    explanation_prompt,
    system_prompt,
)
from app.utils.chat2plot.render import draw_altair, draw_plotly
from app.utils.chat2plot.schema import PlotConfig, ResponseType, get_schema_of_chart_config
    ...
    def _parse_response(
        ...
        try:
            if self._custom_deserializer:
                ...
                config = self._target_schema.model_validate(json_data)
            ...
            jsonschema.validate(json_data, self._target_schema.model_json_schema())
            raise
