...
const TableNameKnowledgeNetworkInfo = "t_knowledge_network_info"

// KnowledgeNetworkInfo mapped from table <t_knowledge_network_info>
type KnowledgeNetworkInfo struct {
	...
	UpdatedAt *time.Time            `gorm:"column:f_updated_at;autoUpdateTime;not null;comment:更新时间" json:"updated_at"` // 更新时间
	DeletedAt soft_delete.DeletedAt `gorm:"column:f_deleted_at;not null;comment:删除时间戳;softDelete:milli" json:"deleted_at"`                          // 删除时间戳
}

func (m *KnowledgeNetworkInfo) BeforeCreate(_ *gorm.DB) error {
	if m == nil {
		return nil
	}
...
// TableName KnowledgeNetworkInfo's table name
func (*KnowledgeNetworkInfo) TableName() string {
	return TableNameKnowledgeNetworkInfo
}
